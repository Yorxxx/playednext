...
public class RevealBackgroundView extends View {
    ...
    public static final int STATE_UNFILL_STARTED = 3;
    ...
    public void hideFromLocation(int[] tapLocationOnScreen) {
        changeState(STATE_UNFILL_STARTED);
        filling = false;
        startLocationX = tapLocationOnScreen[0];
        startLocationY = tapLocationOnScreen[1];
    ...
    protected void onDraw(Canvas canvas) {
        if (state == STATE_FINISHED && filling) {
